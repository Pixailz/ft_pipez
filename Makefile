...
#    Updated: 2022/05/26 21:39:35 by brda-sil         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(orange_star) $(bold)INFO$(font_color):
    ...
    ./$(TARGET) "$(bold)infile$(font_color)" $(bold)||$(font_color) \
("$(bold)here_doc$(font_color)" "$(bold)LIMITER$(font_color)") \
$(bold)||$(font_color) ("$(bold)here_cmd$(font_color)" "$(bold)CMD$(font_color)")\
$(font_color)<$(bold)cmd1$(font_color)> $(font_color)<$(bold)cmd2$(font_color)> \
$(font_color)[$(bold)cmd3$(font_color)...$(bold)cmdN$(font_color)] \
$(font_color)<$(bold)outfile$(font_color)>

        $(bold)here_doc$(font_color):
            $(bold)infile$(font_color) become the $(bold)user input $(font_color) \
limited by the $(bold)LIMITER$(font_color)

        $(bold)here_cmd$(font_color):
            $(bold)infile$(font_color) become the $(bold)output$(font_color) of the command $(bold)CMD$(font_color)

        $(bold)cmd$(font_color):
            should have, at least $(bold)2$(font_color) command.
            if $(bold)here_cmd$(font_color) is present, \
the first command $(bold)doesn't $(font_color)count.
